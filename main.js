...
function preload() {
    ...
    game.load.image('cena', 'assets/cena.png')
    game.load.image('ultimateDankMaster','assets/negev.png');
    //Download http://s10.postimg.org/armp4u0s9/snoopgas.png
...
function create(){
    memes =  ['frog','pony','lenny','troll','mlgdog','doge','shrek','illuminati','elmo','sniper','hitmarker','doritos','mtnDew','cena'];
    game.physics.startSystem(Phaser.Physics.ARCADE);
    game.stage.backgroundColor = '#ffffff';
    mlgBackground = game.add.sprite(0,-50,'background');
    mlgBackground.scale.setTo(10,3);
    mlgBackground.alpha = 0.0;
    ...
    dankmemes1.makeParticles(memes);
    ...
    dankmemes2.makeParticles(memes);
    ...
    for (var i = 0; i < 10; i++)
    {
        ...
        enemy.events.onOutOfBounds.add(losePoints, this);
    }
    for (var i = 0; i < 10; i++)
    {
        ...
        enemy2.events.onOutOfBounds.add(losePoints, this);
...
function update(){
        ...
        game.physics.arcade.collide(dankExplosion);
        game.physics.arcade.collide(dankExplosion2);
        
        if(mlgLevel < 14200 && mlgLevel > 0){
    ...
    dankmaster.makeParticles(memes);
    ...
    // if(ultimateTrigger == 1){
    //     gun.loadTexture('ultimateDankMaster');
    // }
...
function dankExplosion(mousex, mousey){
    var dankExplosion = game.add.emitter(mousex, mousey, 5);
    dankExplosion.makeParticles(memes);
    dankExplosion.minParticleScale = 0.1;
    dankExplosion.maxParticleScale = 0.15;
    dankExplosion.start(true, 2000, null, 10);
